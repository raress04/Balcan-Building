...
const Home: React.FC = () => {
  ...
  return (
    <>
      <Header active={active} onNavigate={scrollToId} />
      <main>
        <Hero onCTAClick={() => scrollToId('services')} onContactClick={() => scrollToId('contact')} />
        <About />
        <Services />
        <MasonryGallery />
        <Providers />
...
export const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <a href="#" className="scrollup" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }) }}>
        ↑
      </a>
    </>
  )
